...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65_with_macro(
    ...
    KC_F9,   KC_F10,  KC_LCTL,  KC_LGUI, KC_LALT, MO(_FN1),KC_SPC,           KC_SPC,  MO(_FN1),KC_RALT, UMLT,   KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT 
  ),
  ...
  [_FN1] = LAYOUT_65_with_macro(
    ...
    _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_H   , _______, _______, _______, _______, _______, _______, _______, KC_PGUP, \
