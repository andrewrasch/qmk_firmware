...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [FN1] = LAYOUT_65_with_macro(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, XP(U_UMLT, U_UMLT_C) , _______, XP(O_UMLT, O_UMLT_C) , _______, _______, _______, _______, _______, \
    _______, _______, _______, XP(A_UMLT, A_UMLT_C) , XP(ESZETT, ESZETT_C) , _______, _______, KC_H   , _______, _______, _______, _______, _______, _______, _______, KC_PGUP, \
    ...
    _______, _______, KC_TILD, _______, _______, _______, _______,          _______, _______, _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT
  )
};
